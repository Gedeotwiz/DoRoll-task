...
import { useGetTaskRelatedToUserIdQuery } from "../redux/task/api/apiSlice";
...
export default function UserPercent(){

    const { data: tasks, isLoading, error } = useGetTaskRelatedToUserIdQuery();
