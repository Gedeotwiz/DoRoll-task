...
import {  
  useUpdateTaskStatusMutation,useUpdateTaskMutation, useDeleteTaskMutation ,useGetTasksQuery} from '../redux/task/api/apiSlice';
...
export default function UserTask({ searchTerm }: { searchTerm: string }) { 
  ...
  const filteredData = data?.data?.filter((task: any) =>
